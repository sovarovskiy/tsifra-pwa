...
const вопросы = [
  ...
  },
  {
    ...
    параметры: [
      { центр: 'большой', этикетка: '' Большой},
      { центр: 'средний', этикетка: 'Средний' },
            { центр: 'малый', этикетка: 'Малый' 
                  ]
        },
  ...
  {
    код: 'данные_сделка',
    текст: 'Для точного расчёта укажите, пожалуйста, ID сделки или номер объекта',
    намекать: 'Сбор данных: ID сделки',
    параметры: [
      { центр: 'указал', этикетка: 'Указал ID' },
      { центр: 'нет_id', этикетка: 'Нет ID / не знаю' }
    ]
  },
  {
    код: 'данные_телефон',
    текст: 'Оставьте, пожалуйста, контактный телефон для связи',
    намекать: 'Сбор данных: телефон контакта',
    параметры: [
      { центр: 'указал', этикетка: 'Указал телефон' },
      { центр: 'отказ', этикетка: 'Предпочитаю email' }
    ]
  },
  {
    код: 'подтверждение',
    текст: 'Отлично! Я подготовлю расчёт и вышлю вам в течение 24 часов. Подтверждаете?',
    намекать: 'Финальное подтверждение готовности',
    параметры: [
      { центр: 'да', этикетка: 'Да, жду расчёт' },
      { центр: 'позже', этикетка: 'Свяжемся позже' }
    ]
  },
  {
    код: 'завершение',
    текст: 'Спасибо за уделённое время! Я зафиксировал все данные. До связи!',
    намекать: 'Завершение квалификации',
    параметры: [
      { центр: 'завершено', этикетка: 'Завершить' }
    ]
  }
];
